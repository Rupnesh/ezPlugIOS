...
const categoriesRoutes: Routes = [
  ...
  { path: 'station-details-ble', loadChildren: () => import('../dashboardPages/station-details-ble/station-details-ble.module').then(m => m.StationDetailsBlePageModule) },
  { path: 'charge-ble', loadChildren: () => import('../dashboardPages/station-details-ble/charge/charge-ble.module').then(m => m.ChargeBlePageModule) },
